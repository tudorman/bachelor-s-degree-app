  ...
  return (
    <div className="rootChoose">
      ...
      <div className="detailsHeader">
        <h1 id="detailHeader">
          <i>Select your departure flight...</i>
        </h1>
                        ...
                        <Button
                          onClick={() => {
                            let departure_flight = {
                              departure_id: flight.flight_no,
                              departure_company: flight.company,
                              departure_departure_place: flight.departure_place,
                              departure_arrival_place: flight.arrival_place,
                              departure_departure_time: flight.departure_time,
                              departure_arrival_time: flight.arrival_time,
                              departure_duration: flight.duration,
                              departure_price_per_person:
                                flight.price_per_person,
                              departure_num_of_stops: flight.num_of_stops,
                            };
                            let return_flight = {
                              return_id: "-",
                              return_company: "-",
                            ...
                            fetch("http://localhost:5000/departure-data", {
                              ...
                              body: JSON.stringify(departure_flight),
                            })
